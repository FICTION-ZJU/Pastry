...
├── benchmarks    # Benchmarks that are known unsupported by a tool are excluded from the corresponding directory
...
│   ├── test      # Contains the three test programs required for Smoke testing Pastry's functionality
│   ├── src       # Core source code of the Pastry 
│   └── ...
...
This will run four tools: TODO on each file. 
